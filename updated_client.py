...
paddle_hit_sound = load_sound_safe('gromkiy-udar-raketkoy.wav', 0.6)  # Звук удару по ракетці
wall_hit_sound = load_sound_safe('tennis-aplodismentyi-zriteley-3-25666.wav', 0.4)      # Звук удару об стіну
menu_click_sound = load_sound_safe('paddle_hit.wav', 0.5)   # Звук кліку в меню
win_sound = load_sound_safe('vnutrennee-prostranstvo-universiteta-tochka-nastolnogo-tennisa.wav', 0.7)                # Звук перемоги
lose_sound = load_sound_safe('zvukovyie-effektyi-paketa-nastolnogo-tennisa-39917.wav', 0.7)              # Звук поразки
